...
library(here)
here()
NEON_NIWO_Litter_mass_trap_Processed <- read.csv(here("Data/Processed_key/NEON_NIWO_Litter_mass_trap_Processed.csv"), stringsAsFactors = T)
NTL_PeterPaul <- read.csv(here("Data/Processed_key/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv"), stringsAsFactors = T)
#2 
