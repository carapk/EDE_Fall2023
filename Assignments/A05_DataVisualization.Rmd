...
library(here)
here()
NEON_NIWO_Litter_mass_trap_Processed <- read.csv(here("Data/Processed_key/NEON_NIWO_Litter_mass_trap_Processed.csv"), stringsAsFactors = TRUE)
NTL_PeterPaul <- read.csv(here("Data/Processed_key/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv"), stringsAsFactors = TRUE)
#2 
...
my_theme <- theme_base()  + 
  theme(
    ...
    rect =element_rect('white'),
    text = element_text(size=12, color='black'),
    plot.title = (color='blue'),
