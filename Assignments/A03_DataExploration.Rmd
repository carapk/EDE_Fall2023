...
#view the dimensions in the console
...
# printing this summart to the console
print(Neonics_effects_summary)
...
# viewing the summary
print(Neonics_species_summary)
```

> Answer: The six most commonly studied species are the Honey Bee, the Parasitic Wasp, and the Buff Tailed Bumblebee. 
...
> Answer: The class of Conc.1.Author is a factor. This is used when 
