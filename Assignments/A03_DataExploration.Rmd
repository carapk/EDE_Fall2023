...
# using the summary function to view a summary of the most common effects found in the effect column of the Neonics df
...
# using summary to find the six most commonly studied species in the dataset using their common name
...
> Answer: The six most commonly studied species are the Honey Bee, the Parasitic Wasp, and the Buff Tailed Bumblebee. The three of these species all offer ecosystem services that are very important to the health of the ecoystem. All three act as polinators, however the Buff Trailed Bumblbee and the Honey Bee are far more effective than the Parasitic Wasp. However, the Parasitic Wasp is important in managing the population of other forests pests and keeping populations of other insect species in check. 
...
> Answer: The class of Conc.1.Author is a factor. This is used to categorize and store data when the dataset has a limited number of different values. It is not numeric becasue 

## Explore your data graphically (Neonics)

9.  Using `geom_freqpoly`, generate a plot of the number of studies conducted by publication year.

```{r Number of Studies by publication year in Neonics}
# inputting neonics dataset to the plot
Q9 <- ggplot(Neonics) +
  
  # creating a frequency plot with publication year on x axis and count of studies on y
  # setting the bin number to 40 and binwidth to 1 to represent a 40 year time period of options
...
```{r Number of Studies in Neonics by publication year with location colors}
# inputting neonics dataset to the plot
Q10 <- ggplot(Neonics) +
  
    # creating a frequency plot with publication year on x axis and count of studies on y
  # setting the bin number to 40 and bin width to 1 to represent a 40 year time period of options
...
geom_freqpoly(aes(x = Publication.Year, color=Test.Location), bins=40, binwidth=1) +
  ...
  # putting the legend at the top for easier viewing
...
> Answer:The summary shows you how many of each unique plot there are in the sample, whereas unique only shows you the names of the unique plot IDs. You can use length to find the amount of unique plots sampled for each. Summary provides more information regarding the count of plots than unique
