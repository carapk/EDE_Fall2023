...
```{r DataExercise-1a}
high_F <- c(80,83,83,83,77,70,78,82,85,83)

low_F <- c(55,56,57,60,61,61,62,63,63,62)
```
...
```{r DataExercise-1c}
df_temp <- data.frame("High temp in F"= high_F,"High temp in C"= high_C, "Low temp in F" = low_F, "Low temp in C" =low_C)
```
